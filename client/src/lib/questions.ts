...
export const questions: Question[] = [
  {
    ...
    options: ["yes", "No"],
    correctAnswer: 1,
    explanation: "AWaRe is specifically for antibiotics to guide their rational use."
  },
  {
    id: 2,
    ...
    options: ["yes", "No"],
    correctAnswer: 1,
    explanation: "Ensuring the availability of 'Access' antibiotics is a key object to improve treatment of common infections and reduce the misuse of higher-risk antibiotics"
  },
  {
    id: 3,
    ...
    options: ["yes", "No"],
    correctAnswer: 0,
    explanation: "The WHO set a target for countries to achieve at least 60% of their antibiotic consumption from the Access category to promote safer prescribing practices."
  },
  {
    id: 4,
    ...
    options: ["yes", "No"],
    correctAnswer: 1,
    explanation: "Reserve antibiotics are preserved for severe cases involving multidrug-resistant bacteria to prevent the spread of resistance."
  },
  {
    id: 5,
    ...
    options: ["yes", "No"],
    correctAnswer: 1,
    explanation: "Prophylactic antibiotics should only be administered in specific cases, such as for surgical prophylaxis."
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation: "MDR is The ability of microorganisms to resist one antimicrobial agents from three different classes, making infections harder to treat"
  },
  {
    id: 7,
    ...
    options: ["yes", "No"],
    correctAnswer: 0,
    explanation: "Access antibiotics are safe, effective, and recommended as first-line options."
  },
  {
    id: 8,
    ...
    options: ["yes", "No"],
    correctAnswer: 0,
    explanation: "Even Access antibiotics should be used in rational way to minimize resistance."
  },
  {
    id: 9,
    ...
    correctAnswer: 0,
    explanation: "Amoxicillin is an Access antibiotic and the first-line treatment for pediatric ear infections."
  },
  {
    id: 10,
    ...
    options: ["Approve the prescription", "Recommend Nitrofurantoin", "Suggest Colistin"],
    correctAnswer: 1,
    explanation: "Nitrofurantoin is an Access antibiotic suitable for uncomplicated UTIs, reducing resistance risks. Ciprofloxacin is a Watch antibiotic and should not be used for mild infections. Reserve antibiotics like Colistin are inappropriate for simple UTIs and should be preserved for critical cases."
  },
  {
    id: 11,
    text: "A 25-year-old patient has a mild skin infection (impetigo). What treatment would you recommend?",
    options: ["Topical antibiotics like Mupirocin", "Oral Clindamycin", "Oral Ciprofloxacin"],
    correctAnswer: 0,
    explanation: "Mupirocin is an Access antibiotic suitable for mild skin infections, avoiding systemic antibiotic use. Clindamycin for skin infections should be preserved for MRSA infections not mild infections. Ciprofloxacin, are not required for localized skin infections"
  },
  {
    id: 12,
    ...
    correctAnswer: 2,
    explanation: "Antibiotics from the Access category, like Cefazolin, are suitable for surgical prophylaxis to prevent infection"
  },
  {
    id: 13,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: "Broad-spectrum Access antibiotics should be started while awaiting culture. The absence of empirical antibiotics in the presence of an active infection worsening complications. Reserve antibiotics should be used only for confirmed resistant cases."
  },
  {
    id: 15,
    ...
    correctAnswer: 0,
    explanation: "Doxycycline, an Access antibiotic, is effective for mild to moderate COPD exacerbations. Ciprofloxacin is a Watch antibiotic and not the first-line choice for COPD exacerbations. Reserve antibiotics like Linezolid are not needed in this scenario"
  },
  {
    id: 16,
    ...
    correctAnswer: 1,
    explanation: "Fluoroquinolones is first line in mild to moderate cases. Nitrofurantoin is an Access antibiotic suitable for lower UTIs. Amoxicillin is not effective for many UTI pathogens."
  },
  {
    id: 17,
    ...
    correctAnswer: 2,
    explanation: "metronidazole is acess antibiotic, piperacillin/Tazobactam is watch antibiotic, Tigecycline is reserve antibiotic"
  },
  {
    id: 18,
    ...
    options: ["yes", "No"],
    correctAnswer: 1,
    explanation: "Amikacin belongs to the Access group in spite of it's potential side effects. It's classified in this group due to it's relatively low potential for inducing antimicrobial resistance when compared to other antibiotics."
  },
  {
    id: 19,
    ...
    options: ["yes", "No"],
    correctAnswer: 0,
    explanation: "Watch antibiotics require closer monitoring due to their resistance potential."
  },
  {
    id: 20,
    ...
    correctAnswer: 0,
    explanation: "Levofloxacin (Flouroquinolones)is watch antibiotic, sulfamethoxazole/trimethoprim is acess antibiotc, Colistin is reserve antibiotic"
  },
  {
    id: 21,
    text: "A 70-year-old patient develops diarrhea after recent antibiotic use. What is the appropriate treatment?",
    options: ["Oral Vancomycin", "Amoxicillin", "Ciprofloxacin"],
    correctAnswer: 0,
    explanation: "Oral Vancomycin is a Watch antibiotic specifically used for severe C. difficile infections. Amoxicillin can worsen C. difficile infections. Fluoroquinolones are not appropriate for treating C. difficile."
  },
  {
    id: 22,
    ...
    correctAnswer: 0,
    explanation: "Piperacillin-tazobactam, a Watch antibiotic, is effective against the mixed organisms in intra-abdominal infections. Clindamycin does not provide adequate coverage for intra-abdominal infections. Ciprofloxacin alone is insufficient for broad-spectrum coverage."
  },
  {
    id: 23,
    ...
    correctAnswer: 0,
    explanation: "Ceftriaxone, a Watch antibiotic, is recommended for gonorrhea due to increasing resistance to other treatments. Fluoroquinolones are no longer first-line due to resistance. Azithromycin alone is not sufficient for gonorrhea treatment"
  },
  {
    id: 24,
    ...
    correctAnswer: 1,
    explanation: "Ceftriaxone, a Watch antibiotic, is effective against typhoid fever caused by Salmonella typhi"
  },
  {
    id: 25,
  ...
  },
  {
    ...
    options: ["yes", "No"],
    correctAnswer: 0,
    explanation: "Reserve antibiotics play a critical role in managing multidrug-resistant, culture-confirmed infections and must be preserved to maintain their effectiveness."
  },
  {
    id: 27,
    ...
    correctAnswer: 2,
    explanation: "Colistin is reserve antibiotic, Meropenem is watch antibiotic, Gentamicin is acess antibiotic"
  },
  {
    id: 28,
    ...
    correctAnswer: 1,
    explanation: "Colistin, a Reserve antibiotic, is crucial for treating multidrug-resistant & culture-confirmed infections like sepsis in critical patients. Ciprofloxacin is ineffective against resistant organisms causing sepsis. Watch antibiotics like Cefepime are ineffective for highly resistant infections."
  },
  {
    id: 29,
    ...
    correctAnswer: 2,
    explanation: "Colistin is a Reserve antibiotic, used only for severe infections caused by multidrug-resistant & culture-confirmed infections. Cefepime and Ceftriaxone do not cover carbapenem-resistant Klebsiella."
  },
  {
    id: 30,
    ...
    correctAnswer: 1,
    explanation: "Tigecycline is a Reserve antibiotic used for multidrug-resistant & culture-confirmed Acinetobacter infections"
  },
  {
    id: 31,
    ...
    options: ["Tigecycline", "Meropenem", "Linezolid"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: "Vancomycin targeting MRSA with proven efficacy in endocarditis. Linezolid is bacteriostatic and not effective for infective endocarditis, which requires bactericidal antibiotics."
  },
  {
    id: 33,
    ...
    correctAnswer: 0,
    explanation: "narrow-spectrum is preferred for low-risk, stable patients with mild CAP. Broad-spectrum is reserved for severe cases or patients with risk factors for resistant organisms."
  },
  {
    id: 34,
